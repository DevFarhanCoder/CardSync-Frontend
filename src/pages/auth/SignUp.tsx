  ...
  return (
    <div className="min-h-screen grid place-items-center bg-[var(--bg)]">
      <div className="card w-full max-w-md p-8">
        ...
        <p className="text-center text-[var(--subtle)] mt-1">Start your 14-day free trial</p>
        <form className="mt-6 grid gap-4">
          <div>
            <label className="text-sm">Full Name</label>
            <input className="mt-1 w-full rounded-xl bg-[var(--muted)] border border-[var(--border)] px-3 py-2" placeholder="John Carter"/>
          </div>
          <div>
        ...
        <p className="text-center text-sm text-[var(--subtle)] mt-4">
          Already have an account? <Link to="/signin" className="text-[var(--gold)]">Sign in</Link>
        </p>
      </div>
    </div>
  )
